...
export function getDefaultNotes(req, res) {
  notesDao
    .getDefaultNotes(req.header("uid"))
    .then(function (notes) {
      res.json({
        notes,
      });
